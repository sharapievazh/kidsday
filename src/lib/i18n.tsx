...
const DICT = {
  en: {
    ...
    roleHint: "👤 Parent — manages the whole family. 🧒 Kid — ask your parent for your PIN.",
    parent: "Parent",
    myself: "Me",
    ...
    accountDeleted: "Account deleted. See you soon!",
    ...
    completionsMonth: "Done this month",
    completionsYear: "Done this year",
    noProgressYet: "No completions in this range yet.",
    less: "Less",
    more: "More",
    wdMon: "Mon",
    wdWed: "Wed",
  ...
  ru: {
    ...
    appTagline: "Трекер привычек и заданий для детей",
    switch: "Сменить",
    signOut: "Выйти",
    save: "Сохранить",
    delete: "Удалить",
    ...
    accountDeleted: "Аккаунт удалён. До встречи!",
    ...
    completionsMonth: "Сделано за месяц",
    completionsYear: "Сделано за год",
    noProgressYet: "Пока нет выполненных заданий за этот период.",
    less: "Меньше",
    more: "Больше",
    wdMon: "Пн",
    wdWed: "Ср",
